...
class TestPineconeIndexer(unittest.TestCase):
    """
    ...
    def setUp(self):
        ...
        self.indexer = PineconeIndexer(self.index_name, self.pinecone_api_key, self.cohere_api_key)
...
if __name__ == "__main__":
    unittest.TestLoader.sortTestMethodsUsing = PineconeIndexer.sort_test_methods
    unittest.main()
